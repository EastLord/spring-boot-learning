package com.dongjun.mail.demo.business;
...
public class SpringMailConfig implements ApplicationContextAware, EnvironmentAware {
	...
	/*
	 * SPRING + JAVAMAIL: JavaMailSender instance, configured via .properties
	 * files.
	 */
	@Bean
	 ...
	 * made available for the web-side template engine) delegate to this one,
	 * and thus effectively merge email messages into web messages and make both
	 * types available at the web side, which could bring undesired collisions.
	 *
	 * NOTE also that given we want this specific message source to be used by
	 * our SpringTemplateEngines for emails (and not by the web one), we will
	 * set it explicitly into each of the TemplateEngine objects with
